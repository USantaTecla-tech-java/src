package es.usantatecla.a3_numbers.a1_integerDivision.v0_1;
...
public class App {
    ...
    static int getRemainder(int dividend, int divider){
      return dividend % divider;
    }

    static int getQuotient(int dividend, int divider){
      return (dividend - getRemainder(dividend, divider)) / divider;
    }
