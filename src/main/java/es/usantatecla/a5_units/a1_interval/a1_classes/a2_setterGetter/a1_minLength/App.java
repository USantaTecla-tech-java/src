package es.usantatecla.a5_units.a1_interval.a1_classes.a2_setterGetter.a1_minLength;
...
class Interval {
    ...
    public void setMin(double min){
        this.min = min;
        this.setMax(this.min + this.length);
    }

    public double getMax() {
        return this.getMin() + this.length();
    }

    public void setMax(double max){
        this.setLength(max-this.getMin());
    }
