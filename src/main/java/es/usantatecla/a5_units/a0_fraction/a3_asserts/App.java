...
public class App {
  ...
  public static void main(String[] args) {
    ...
    // console.writeln(fraction1.opposite().toString());
    // console.writeln(fraction1.reverse().toString());
    // Fraction fraction2 = new Fraction();
    // fraction2.read();
    // console.writeln(fraction2.getValue());
    // console.writeln(fraction2.opposite().toString());
    // console.writeln(fraction2.reverse().toString());
